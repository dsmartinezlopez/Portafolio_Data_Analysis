...
Código completo: [Logistics Operations](https://github.com/dsmartinezlopez/Portafolio_Data_Analysis/blob/Portafolio-projects-1/SQLQueryProyectoLogisticOperations.sql)
