...
#### 3. Si la clasificación de los productos se establece de acuerdo al peso volumétrico, donde SMALL se denomina todo lo que pese <= 8 kg, MEDIUM todo lo que pese > 8 kg y <= 15 kg, y BIG todo lo que pese > 15 kg ¿cuales fueron las clasificaciones que más porcentaje de incumplimiento tuvieron ordenadas de forma descendente?
...
SELECT
	...
	FORMAT(SUM(pedidos_retrasados)*1.0/NULLIF(SUM(enviados)*1.0,0), 'P2') AS porcentaje
FROM(
SELECT
	CASE	
	-- Cálculo del peso volumétrico
		WHEN (A.product_height_cm * A.product_width_cm * A.product_length_cm)/5000 <= 8 THEN 'SMALL'
		WHEN (A.product_height_cm * A.product_width_cm * A.product_length_cm)/5000 > 8 AND (A.product_height_cm * A.product_width_cm * A.product_length_cm)/5000 <= 15 THEN 'MEDIUM'
		WHEN (A.product_height_cm * A.product_width_cm * A.product_length_cm)/5000 > 15 THEN 'BIG'
...
+--------------+------------------+--------------------+------------+
| MEDIUM       | 7174             | 5819               | 81.11%     |
| BIG          | 2991             | 2412               | 80.64%     |
| SMALL        | 100006           | 79089              | 79.08%     |
+--------------+------------------+--------------------+------------+*/
```
...
WITH ventas_mensuales AS (
    SELECT
        DATETRUNC(MONTH, B.order_approved_at) AS mes_pago,
        SUM(TRY_CAST(A.payment_value AS numeric(18,2))) AS total_mes
    FROM Payments$ A
    LEFT JOIN Orders$ B ON A.order_id = B.order_id
    WHERE B.order_approved_at IS NOT NULL
    GROUP BY DATETRUNC(MONTH, B.order_approved_at)
)
SELECT 
    mes_pago,
    FORMAT(total_mes, 'C', 'en-US') AS pago_mensual,
    FORMAT(
        SUM(total_mes) OVER (
            ORDER BY mes_pago 
...
```bash
/*------------------------+---------------+---------------------+
| mes_pago                | pago_mensual  | acumulado_historico |
+-------------------------+---------------+---------------------+
| 2016-10-01 00:00:00.000 | $58,380.74    | $58,380.74          |
| 2016-12-01 00:00:00.000 | $19.62        | $58,400.36          |
| 2017-01-01 00:00:00.000 | $131,835.87   | $190,236.23         |
| 2017-02-01 00:00:00.000 | $291,836.22   | $482,072.45         |
| 2017-03-01 00:00:00.000 | $446,020.61   | $928,093.06         |
| 2017-04-01 00:00:00.000 | $413,537.47   | $1,341,630.53       |
| 2017-05-01 00:00:00.000 | $593,119.02   | $1,934,749.55       |
| 2017-06-01 00:00:00.000 | $515,293.57   | $2,450,043.12       |
| 2017-07-01 00:00:00.000 | $585,260.30   | $3,035,303.42       |
| 2017-08-01 00:00:00.000 | $672,772.79   | $3,708,076.21       |
| 2017-09-01 00:00:00.000 | $717,821.79   | $4,425,898.00       |
| 2017-10-01 00:00:00.000 | $782,898.61   | $5,208,796.61       |
| 2017-11-01 00:00:00.000 | $1,174,911.51 | $6,383,708.12       |
| 2017-12-01 00:00:00.000 | $902,534.69   | $7,286,242.81       |
| 2018-01-01 00:00:00.000 | $1,106,076.67 | $8,392,319.48       |
| 2018-02-01 00:00:00.000 | $984,422.01   | $9,376,741.49       |
| 2018-03-01 00:00:00.000 | $1,170,383.27 | $10,547,124.76      |
| 2018-04-01 00:00:00.000 | $1,137,693.93 | $11,684,818.69      |
| 2018-05-01 00:00:00.000 | $1,180,152.88 | $12,864,971.57      |
| 2018-06-01 00:00:00.000 | $1,028,017.84 | $13,892,989.41      |
| 2018-07-01 00:00:00.000 | $1,043,137.76 | $14,936,127.17      |
| 2018-08-01 00:00:00.000 | $1,035,448.72 | $15,971,575.89      |
| 2018-09-01 00:00:00.000 | $166.46       | $15,971,742.35      |
+-------------------------+---------------+---------------------+*/
