...
### SQL:
####  - **Project 1:**  [Amazon products review](https://github.com/dsmartinezlopez/Portafolio_Data_Analysis/blob/Portafolio-projects-1/SQL/Product_Reviews.md)
  ...
  **Skills:** Data Importation, Data Manipulation, JOINS, aggregation functions, category functions, date functions, CTE query's, sub-query's, windows functions, sub-query's, PIVOT. 
...
####  - **Project 2:**  [Brazilian e-commerce](https://github.com/dsmartinezlopez/Portafolio_Data_Analysis/blob/Portafolio-projects-1/SQL/Brazilian%20E-commerce.md) + [Tableau Dashboard](https://public.tableau.com/app/profile/david.santiago.martinez.lopez/viz/Anlisise-commerceenBrasil/Operativo)
  ...
  **Skills:** Data Importation, Data Manipulation, CTE recursive query's, query optimization, indexes, temporal views, JOINS, window functions, sub-query's.
