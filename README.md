...
Attachs my [CV](https://github.com/dsmartinezlopez/Portafolio_Data_Analysis/blob/main/CV%20(EN)%20-%20David%20Santiago%20Mart%C3%ADnez%20L%C3%B3pez.pdf) in English.


# Portafolio Projects

### SQL:
  - Project 1: [Amazon products review](https://github.com/dsmartinezlopez/Portafolio_Data_Analysis/blob/Portafolio-projects-1/Products_review.sql)
  ...
  **Skills:** Data Manipulation, JOINS, aggregation functions, analytics functions, category functions, date functions, CTE query's, sub-query's, windows functions. 
